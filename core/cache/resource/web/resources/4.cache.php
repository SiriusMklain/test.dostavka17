<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1610816877,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1610816877,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
                ...
                <div class="col-12">
                    <div class="offcanvas_menu_wrapper">
                        ...
                        <div id="menu" class="text-left ">
                                <ul class="offcanvas_main_menu"><li class="menu-item-has-children "><a href="index.php?id=1" >Главная</a></li><li class="menu-item-has-children "><a href="index.php?id=3" >Контакты</a></li><li class="menu-item-has-children">
                                    <a>О нас</a><li class="menu-item-has-children "><a href="index.php?id=5" >Личный кабинет</a></li><li class="menu-item-has-children">
                                    ...
                                    </ul><li class="menu-item-has-children "><a href="index.php?id=12" >Вопросы и ответы</a></li><li class="menu-item-has-children "><a href="index.php?id=14" >oplata</a></li></ul>
                        </div>
                        ...
                        <div class="main-header-item d-flex justify-content-between align-items-center">
                            <div class="main-header-menus  d-flex">
                                <div class="header-btn">
                                    <a href="index.php?id=1">Стекловозов</a>
                                </div>
                                <div class="header-menu d-none d-lg-block">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="main" href="index.php?id=5">Кабинет</a>
                                        </li>
                                   </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-7">
                    <div class="about-main-content">
                        <div class="about-title">
                            <h3 class="title">Компания «Стекловозов».</h3><br>
                            <h4>Оперативная  доставка:</h4>
                            <p>Перевозка стекла – это непростая задача, требующая определенных навыков и опыта работы с хрупкими материалами. Чтобы доставить в полной сохранности хрупкий груз по месту назначения необходимо знать, какие особенности имеет транспортировка стекла и легко повреждаемых грузов, и соблюдать правила подготовки и перевозки.
                            <br>
                                Компания «Стекловозов» имеет огромный опыт транспортировки стекольно-зеркальной продукции, и гарантирует не только оперативную, но и бережную доставку  стекла и зеркал на специально оборудованном собственном транспорте.
                            </p>
                            <br>
                            <br>
                            <h4>Качественный замер и бережный монтаж:</h4>
                            <p>
                                Грамотное и качественное выполнение работ по замеру и установке изделий из стекла и зеркал определяет их дальнейший срок эксплуатации и безопасность для  семьи. <br>
                                Компания «Стекловозов» обладает всеми необходимыми ресурсами, включая грамотный, обученный персонал. <br>
                                Специалисты компании прошли все необходимое обучение и сертификацию, и качественно и профессионально готовы выполнить любой замер и произвести монтаж объектов любого уровня сложности с использованием современного инструмента.
                                <br><br>
                                Только правильный замер и грамотный монтаж помогут обеспечить долгий срок службы Вашего изделия.
                            </p>
                        </div>
                        <br>
                        <div class="about-item d-block d-sm-flex align-items-center">
                            ...
                            <div class="col-lg-12">
                                <div class="about-item-content">
                                    <h4 class="title">Специалисты</h4>
                                    <p>Все наши специалисты проходят обучение и аттестацию ежемесячно, и только после этого могут быть допущены к работе.
                                        Наши специалисты - это гарант того, что работа будет выполнена качественно.
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="footer-area">
        <div class="container">
            ...
            <div class="footer-copyright text-center">
                <p>© Все права защищены 2020 <a target="blank_" href="https://www.zamer.info">Zamer.info</a></p>
            </div>
        </div>
