<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1610798189,
    'editedby' => 1,
    'editedon' => 1610811192,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1610798160,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
                ...
                <div class="col-12">
                    <div class="offcanvas_menu_wrapper">
                        ...
                        <div id="menu" class="text-left ">
                                <ul class="offcanvas_main_menu"><li class="menu-item-has-children "><a href="index.php?id=1" >Главная</a></li><li class="menu-item-has-children">
                                    <a>Контакты</a><li class="menu-item-has-children "><a href="index.php?id=4" >О нас</a></li><li class="menu-item-has-children "><a href="index.php?id=5" >Личный кабинет</a></li><li class="menu-item-has-children">
...
<!--                                <li class="breadcrumb-item"><a href="index.html">Home</a></li>-->
                                <li class="breadcrumb-item active" aria-current="page">Напишите нам если у вас остались вопросы</li>
                            </ol>
                        </nav>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="conatct-info">
                        ...
                        <p>Если у Вас остались вопросы, пожалуйста напишите нам, мы с радостью ответим вам.</p>
                    </div>
                    <div class="conatct-info-item">
                        <div class="item">
                            <i class="flaticon-email"></i>
                            <span>Email</span>
                            <p><a href="mailto:zamer@info.ru" class="">zamer@info.ru</a></p>
                        </div>
                        <div class="item center d-none d-md-block">
                            <i class="flaticon-calling"></i>
                            <span>Телефон</span>
                            <i class="flaticon-calling"></i>
                            <p><a href="tel:+74956404101" class="">+7(495) 640-41-01</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
